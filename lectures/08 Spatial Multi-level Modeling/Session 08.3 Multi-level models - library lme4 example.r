...
# Comparison
# mt.mod:  Moran'I of district level resiudals of glm model with multi-level structure
...
# mt.mod:  Moran'I of district level resiudals of glm model with multi-level structure
# mt.mod2: Moran'I of district level residuals of multi-level model
# mt.mod3: Moran'I of district level residuals of multi-level model with lagged Quality Care variable
mt.mod
mt.mod2
mt.mod3